...
The time taken by the merge algorithm grows linearly with the 

scales linearly with number of primitives

can be mitigated with commits, caching, and efficient repacking of complex OTs
...
Some collaborative editors use version vectors: a vector of version numbers
